# Sokoban in Java connected in a database
...
This project is connected to a data base with phpMyAdmin. Please refer to [How to create a connection with a database ?](Sokoban/how to create a connection with a datbase?)
